...
INPDIR=/eos/cms/store/group/phys_jetmet/blehtela/checkStripUnpacker_03Mar2026/checkStripUnpacker_08mar2026_OUT_performancesRAW/  #dataharvested_checkStripUnpacker_08Mar2026_[default, stripUnpackerTRKcase1].root
INPDIR=/eos/cms/store/group/phys_jetmet/blehtela/checkHPtuning_10Mar2026/checkHPtuning_13mar2026_OUT/   #dataharvested_checkHPtracks_13Mar2026_[default, HPtracksTRK].root


#/eos/cms/store/group/phys_jetmet/blehtela/checkHPtuning_10Mar2026/checkHPtuning_13mar2026_OUT/checkHPtuning_10Mar2026_Muon0-Run2025G-v1_default/harvesting/dataharvested_checkHPtracks_13Mar2026_default.root`
...
OUTDIR=/eos/user/b/blehtela/jmetrigger/plots_HPtracks_Mar2026
...
DATANAME=dataharvested_checkHPtracks_13Mar2026
#dataharvested_checkHPtracks_13Mar2026_[default, HPtracksTRK].root
...
# try pink (either kPink+7, or try 900 or 907, what about 6?)
#version_check_data_new \
jmePlots.py -k run3_jme_compareTRK6 \
-o ${OUTDIR} \
-i ${INPDIR}checkHPtuning_10Mar2026_Muon0-Run2025G-v1_default/harvesting/${DATANAME}_default.root:'default':65:1:24 \
   ${INPDIR}checkHPtuning_10Mar2026_Muon0-Run2025G-v1_HPtracksTRK/harvesting/${DATANAME}_HPtracksTRK.root:'HP tracks':6:1:28 \
