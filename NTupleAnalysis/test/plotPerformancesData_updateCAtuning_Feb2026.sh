...
jmePlots.py -k run3_jme_compareTRK1 \
-o ${OUTDIR} \
-i ${INPDIR}checkCAtuning_06Feb2026_Muon0-Run2025G-v1_default/harvesting/${DATANAME}:'Default':1:1:20 \
   ${INPDIR}checkCAtuning_06Feb2026_Muon0-Run2025G-v1_updatedCAtuningTRK/harvesting/${DATANAME}:'updated CA tuning':632:1:20 \
