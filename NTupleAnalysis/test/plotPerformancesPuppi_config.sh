...
#INPDIR=/eos/user/b/blehtela/puppiTests_15Oct2025_V6_newTEST/
INPDIR=/eos/user/b/blehtela/puppiTests_15Oct2025_jetTriggers/



#OUTDIR=./plots_test_winter24
#OUTDIR=/eos/user/t/tchatzis/plots_calo_thresholds/
OUTDIR=/eos/user/b/blehtela/plots_puppi_15oct2025_jetTriggers/


rm -rf ${OUTDIR}


jmePlots.py -k run3_jme_comparePFVsPFPuppi \
-o ${OUTDIR} \
-i ${INPDIR}harvesting/dataharvested_jetTriggers_myfork_15Oct2025.root:'Default':632:1:20 \
-l '#font[61]{CMS} #font[52]{Run-3 MC} TESTING (puppi)'

#-i ${INPDIR}harvesting/dataharvested_myfork_15Oct2025.root:'Default':632:1:20 \
#-i /eos/user/b/blehtela/pu/test_calojet_default/harvesting/data.root:'Default CaloTower':1:1:20 \
#   /eos/user/b/blehtela/samples2023/test_calojet_ecal_thresh/harvesting/data.root:'PF RecHit Threshold':632:1:20 \
