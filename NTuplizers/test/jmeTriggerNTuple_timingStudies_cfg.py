...
elif opts.reco == 'timingStudies':
   from JMETriggerAnalysis.Common.configs.HLT_75e33_D110_cfg import cms, process  #same as for default
...
#    hltPFSim = cms.InputTag('simPFProducer'),
    hltPFTICL = cms.InputTag('pfTICL'),                 #for timingStudies, having HGCAL timing (21.01.2026)
...
#    hltPFPuppiNoLep = cms.InputTag('hltPFPuppiNoLep'),
  ) if opts.reco=='timingStudies' else cms.PSet(
    #add recoPFCandidateCollections that should be kept by default
  ),
